...
IMAGELESS_PRODUCT_EXCEPTIONS = {
    ...
    ("articles/best-overlanding-camp-chairs-and-tables.html", "NEMO Stargaze EVO-X"),
    ...
    ("articles/best-overlanding-headlamps-and-lanterns.html", "Petzl ACTIK CORE Rechargeable Headlamp 625 Lumens"),
